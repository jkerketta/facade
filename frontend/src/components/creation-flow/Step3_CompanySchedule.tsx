			...
			<div className='relative z-10 p-8'>
				<div className='mb-6'>
					...
					<h1 className='text-4xl font-black tracking-tighter leading-none mb-2'>
						<span className='text-black/90'>CUSTOMIZE YOUR</span>
						<br />
						<span className='text-black/60'>POSTING SCHEDULE</span>
					</h1>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6'>
					<div className='space-y-6'>
							...
							<div className='border border-black/10 bg-white/70 rounded-xl p-6 mt-6'>
							...
							{selectedDate ? (
								(() => {
									...
									return scheduleForSelectedDay.length > 0 ? (
										...
										<div className='text-center text-black/50 pt-10 text-sm'>
											No scheduled events.
										</div>
									);
								})()

			...
			<div className='relative z-10 flex-1 flex flex-col p-8'>
				<div className='mb-8'>
					<div className='flex items-baseline gap-4 mb-4'>
						...
						<span className='text-black/30 text-xs tracking-[0.3em] uppercase'>Identity Matrix</span>
					</div>

					<h1 className='text-5xl font-black tracking-tighter leading-none mb-2'>
						<span className='text-black/90'>FORGE YOUR</span>
						<br />
						<span className='text-black/60'>{influencerType === "lifestyle" ? "DIGITAL PERSONA" : "BRAND ESSENCE"}</span>
					</h1>
				...
				<div className='flex-1 min-h-0 overflow-y-auto pr-4 space-y-6 mb-6'>
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
						<div className='relative group'>
							...
							<div className='relative border border-black/10 bg-white/70 rounded-xl p-6 group-hover:border-black/30 transition-colors duration-500'>
								...
								<input
									...
									className='w-full px-4 py-3 bg-white/80 backdrop-blur-sm border border-black/10 placeholder-black/40 text-black focus:border-black/30 focus:outline-none transition-all duration-300'
									placeholder={
						...
						<div className='relative group'>
							...
							<div className='relative border border-black/10 bg-white/70 rounded-xl p-6 group-hover:border-black/30 transition-colors duration-500'>
								<div className='flex items-center gap-3 mb-4'>
									<span className='inline-flex items-center justify-center w-9 h-9 rounded-lg border border-black/15 bg-[#d9ebff]'>
								...
								<select
									...
									className='w-full px-4 py-3 bg-white/80 backdrop-blur-sm border border-black/10 text-black focus:border-black/30 focus:outline-none transition-all duration-300 cursor-pointer'
								>
									<option value='energetic' className='bg-white'>Energetic</option>
					...
					<div className='relative group'>
						...
						<div className='relative border border-black/10 bg-white/70 rounded-xl p-6 group-hover:border-black/30 transition-colors duration-500'>
							<div className='flex items-center gap-3 mb-6'>
								<span className='inline-flex items-center justify-center w-9 h-9 rounded-lg border border-black/15 bg-[#f0e7a9]'>
							...
							<div className='relative'>
								<div className='absolute top-4 right-4 text-8xl font-black text-black/5'>02</div>
								<textarea
									id='background_info'
									value={background_info}
									onChange={(e) => setBackgroundInfo(e.target.value)}
									className='relative w-full h-48 px-4 py-3 bg-white/80 backdrop-blur-sm border border-black/10 placeholder-black/40 text-black focus:border-black/30 focus:outline-none transition-all duration-300 resize-none'
									placeholder={
										influencerType === "lifestyle"

			...
			<div className='relative z-10 flex-1 flex flex-col p-8'>
				<div className='mb-8'>
					<div className='flex items-baseline gap-4 mb-4'>
						...
						<span className='text-black/30 text-xs tracking-[0.3em] uppercase'>Strategic Planning</span>
					</div>

					<h1 className='text-5xl font-black tracking-tighter leading-none mb-2'>
						<span className='text-black/90'>TARGET YOUR</span>
						<br />
						<span className='text-black/60'>INFLUENCE VECTOR</span>
					</h1>
				...
				{isGenerating && (
					<div className='mb-8 relative group'>
						...
						<div className='relative border border-black/20 bg-white/70 rounded-xl p-6'>
							<div className='flex items-center justify-center gap-4'>
								<div className='relative'>
									<div className='absolute inset-0 bg-white/5 blur-xl scale-150' />
									<Loader2 className='relative w-6 h-6 animate-spin text-black/60' />
								</div>
						...
						<div className='relative group'>
							...
							<div className='relative border border-black/10 bg-white/70 rounded-xl p-6 group-hover:border-black/30 transition-colors duration-500'>
								<div className='flex items-center gap-3 mb-6'>
									...
									<legend className='text-xs font-medium text-black/50 uppercase tracking-wider'>
										Audience Demographics
									</legend>
								</div>
								<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
									<div className='space-y-2'>
										<label className='block text-xs font-medium text-black/40'>
											Min Age
										</label>
										<input
											type='number'
											...
											className='w-full px-3 py-2 bg-white/80 backdrop-blur-sm border border-black/10 text-black focus:border-black/30 focus:outline-none transition-all duration-300'
										/>
									</div>
									<div className='space-y-2'>
										<label className='block text-xs font-medium text-black/40'>
